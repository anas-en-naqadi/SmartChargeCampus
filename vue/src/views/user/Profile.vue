    ...
    <div class="w-full">
        <div class="flex flex-col items-center w-full px-5">
            <div class="flex flex-wrap justify-center items-center w-full mt-12">
                        ...
                        <div class="bg-white  border-t-4 border-green-400">
                            ...
                            <div class="px-2">
                                ...
                                <h3 class="text-gray-600 font-lg text-semibold leading-6">
                                    CNE:
                                    <span class="text-sm font-semibold">{{ user.student.cne }}</span>
                                </h3>
                                <h3 class="text-gray-600 font-lg text-semibold leading-6">
                                    Role:
                                ...
                                <h3 class="text-gray-600 font-lg text-semibold leading-6">
                                    ...
                                    <span class="text-sm font-semibold">{{
                                        user.student.phone_number || "not exist"
                                        }}</span>
                                </h3>
                            </div>
                ...
                <div class="w-full xl:w-2/4 p-3 " @submit.prevent="updatePassword">
                    <form class="card bg-white border w-full border-gray-300 rounded-xl p-6 pb-7">
                        <div class="flex  w-full gap-4 justify-between items-center pb-4">
                        ...
                        <div class="flex flex-wrap mx-3 pb-4">
                            <div class="w-full px-3 mb-4">
                                <label for="current_password"
                                    ...
                                    Password</label>
                                <input required v-model="passwordBag.currentPassword"
                                    :type="showCurrentPassword ? 'text' : 'password'" name="current_password"
                            ...
                            <div class="w-full md:w-6/12 px-3 mb-4">
                                <label for="new_password"
                                    ...
                                    Password</label>
                                <input required v-model="passwordBag.newPassword"
                                    :type="showCurrentPassword ? 'text' : 'password'" name="new_password"
                                    class="focus:shadow-primary-outline white:bg-slate-850 white:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                            </div>
                            <div class="w-full md:w-6/12 px-3 mb-4">
                                <label for="confirm_password"
                                    ...
                                    Password</label>
                                <input required v-model="passwordBag.newPassword_confirmation"
                                    :type="showCurrentPassword ? 'text' : 'password'" name="confirm_password"
                                    class="focus:shadow-primary-outline white:bg-slate-850 white:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                            </div>
                        </div>
                    </form>
                        ...
                        <div id="profile" class="flex flex-wrap -mx-3 pb-2">
                            ...
                            <div class="w-full md:w-6/12 px-3 mb-4">
                                <label for="universite"
                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 white:text-white/80">
                                    Université</label>
                                <input required v-model="user.student.university" type="text" id="universite"
                                    class="focus:shadow-primary-outline white:bg-slate-850 white:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                            </div>
                            <div class="w-full md:w-6/12 px-3 mb-4">
                                <label for="year_of_study"
                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 white:text-white/80">
                                    Année d'étude</label>
                                <input required v-model="user.student.year_of_study" type="number" name="year_of_study"
                                    class="focus:shadow-primary-outline white:bg-slate-850 white:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                            </div>
                            <div class="w-full md:w-6/12 px-3 mb-4">
                                <label for="filiere"
                                ...
                                <input required v-model="user.student.sector" type="text" name="last_name"
                                    class="focus:shadow-primary-outline white:bg-slate-850 white:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                            </div>
                            <div class="w-full md:w-6/12 px-3 mb-4">
                                <label for="phone"
                                    ...
                                    Number</label>
                                <input v-model="user.student.phone_number" type="text" name="phone"
                                    class="focus:shadow-primary-outline white:bg-slate-850 white:text-white text-sm leading-5.6 ease block w-full appearance-none rounded-lg border border-solid border-gray-300 bg-white bg-clip-padding px-3 py-2 font-normal text-gray-700 outline-none transition-all placeholder:text-gray-500 focus:border-blue-500 focus:outline-none" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="card bg-white border border-gray-300 rounded-xl p-6 pb-0">
                    ...
                    <div class="flex-auto p-6">
                        ...
                        <div id="profile" class="flex flex-wrap -mx-3 pb-2">
                            ...
                            <div class="w-full md:w-6/12 px-3 mb-4">
                                <label for="year_of_study"
                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 white:text-white/80">Année
                                    d'étude
                                </label>
                                <Skeleton></Skeleton>
                            </div>
                            <div class="w-full md:w-6/12 px-3 mb-4">
                                <label for="filiere"
                                    class="inline-block mb-2 ml-1 font-bold text-xs text-slate-700 white:text-white/80">Filière
                                </label>
                                <Skeleton></Skeleton>
                            </div>
                            <div class="w-full md:w-6/12 px-3 mb-4">
