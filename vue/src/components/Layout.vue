...
<template>
    ...
    <div>
        ...
        <div class="flex overflow-hidden bg-white pt-16">
            <aside id="sidebar"
                class="fixed z-20 hidden  h-full top-0 left-0 pt-14 flex lg:flex flex-shrink-0 flex-col w-56  transition-width duration-75"
                aria-label="Sidebar">
            ...
            <div id="main-content"
                class="h-full w-full m-auto bg-gray-50 relative overflow-y-auto overflow-x-hidden lg:ml-64 ">
                <main>
